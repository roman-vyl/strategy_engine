...
- [x] Treat a configured all-null stop or take series as not ready during warmup.
- [x] Add regression coverage distinguishing configured all-null protection from an absent rule kind.
